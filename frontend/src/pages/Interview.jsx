    ...
    return (
      <div className="min-h-screen app-bg text-white">
        ...
        <div className="flex items-center justify-center px-4 pb-8">
          <form onSubmit={handleStart} className="bg-black/20 backdrop-blur-sm p-8 rounded-lg w-full max-w-md space-y-4">
        ...
        <div className="flex flex-col items-center px-6 pb-8">
          <div className="w-full max-w-2xl space-y-6">
            ...
            <textarea
              ...
              className="w-full p-3 rounded bg-white/10 outline-none h-32 resize-none"
            />
  ...
  return (
    <div className="min-h-screen app-bg text-white">
      ...
      <div className="max-w-2xl mx-auto px-6 pb-8 space-y-6">
        ...
        {results.map((r, i) => (
          <div key={i} className="bg-black/20 backdrop-blur-sm p-4 rounded-lg space-y-2">
            <p className="font-semibold">{r.question}</p>
            <p className="text-gray-300 text-sm">Your answer: {r.answer}</p>
            <p className="text-blue-300 font-bold">Score: {r.score}/10</p>
